    ...
    <div class="flex justify-center items-center w-screen h-screen m-0 bg-cover bg-[url(https://i.pinimg.com/736x/6e/2d/97/6e2d971d054aa9529d539e88748e9753.jpg)]">
        <div class="bg-gray-50/80 p-8 rounded-2xl">
            <form class="flex flex-col items-center gap-2">
                <h1 class="text-2xl text-center font-bold text-black">Welcome Back!</h1>
                ...
                <button @click="login()" type="button" class="mt-6 w-60 font-medium py-2 bg-blue-500 rounded-lg text-white hover:cursor-pointer">Sign in</button>
            </form>
        </div>
    </div>
</template>
